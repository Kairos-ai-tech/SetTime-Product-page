...
const translations = {
  "zh-TW": {
    ...
    "status.live": "已上線",
    "status.dev": "開發中",
    "hero.badge": "AI 鋼筋估算自動化平台",
    "hero.title": ["結構施工圖", "自動轉成鋼筋計料與加工圖"],
    "hero.subtitle": "已上線：估算自動化（AutoCAD 外掛 + 桌面版）。規劃中：AR 綁紮指導、AI 竣工比對與可稽核紀錄。",
    "hero.subtitle-en": "From structural drawing to shop-ready rebar.",
    "hero.cta": "開始合作",
    "hero.stat1.label": "鋼筋返工降幅 (目標)",
    "hero.stat2.label": "估算工時節省 (目標)",
    "hero.stat3.label": "年市場規模 TWD（產業估計）",
    "hero.stat3.unit": "兆",
    ...
    "problem.stats.source": "產業估計數據，非本產品實測結果。",
    "solution.label": "OUR TECHNOLOGY 核心技術",
    "solution.heading": ["端到端施工執行管線"],
    "solution.lead": "以結構施工圖為唯一真值：估算自動化已上線，AR 現場指導與 AI 竣工驗證規劃中",
    "aria.langSelect": "語言",
    ...
    "solution.t1.desc": "結構施工圖 → 鋼筋計料表、下料表、加工表。自動生成可直接送交加工廠的數位資料。",
    ...
    "product.tagline": "SetTime — 凝固之前，一次到位",
    ...
    "compliance.label": "LAW & COMPLIANCE 法遵與稽核",
    "compliance.heading": ["每一筆紀錄，完整留存供稽核與法律程序查閱"],
    "compliance.lead": "從圖紙解析到現場驗證，每個動作將寫入竄改可偵測的稽核鏈（開發中），支援大型營造集團與政府標案的稽核審查需求。",
    "compliance.moat1.title": "竄改可偵測鏈式雜湊",
    "compliance.moat1.desc": "每筆紀錄以 SHA-256 串接前一筆雜湊，任何竄改或刪除將可立即偵測（開發中）",
    "compliance.moat2.title": "精確時間戳記",
    "compliance.moat2.desc": "UTC 時間戳配合連續序號，將杜絕事後補登、跳號或竄改時序（開發中）",
    "compliance.moat3.title": "僅可新增稽核紀錄",
    "compliance.moat3.desc": "僅可新增、不可修改或刪除，未來可完整匯出供法律取證與主管機關查核（開發中）",
    "compliance.moat4.title": "長期保存相容架構",
    "compliance.moat4.desc": "紀錄格式具版本控管，將確保跨年度保存週期仍可完整驗證還原（開發中）",
    "compliance.disclaimer": "稽核鏈為技術性防竄改機制，不構成對任何特定法規、驗收基準或政府標案要求之合規保證。實際法遵義務依個案適用法規及契約條款而定，建議就個案洽詢法律顧問；本頁面內容不構成法律意見。",
    ...
    "process.s2.desc": "驅動加工廠機具；QR 標籤與依澆置區配送規劃中",
    ...
    "advantage.moat1.desc": "每一個案場累積 as-built 資料，模型越用越準（開發中），形成台灣專屬資料護城河",
    "advantage.moat2.title": "本地 CV 模型",
    "advantage.moat2.desc": "以台灣工地實拍訓練的鋼筋驗證模型，對國產鋼筋規格與工法最敏感（開發中）",
    "advantage.moat3.title": "公共工程關係",
    "advantage.moat3.desc": "支援公共工程稽核審查需求（開發中），主動參與制定智慧工地竣工紀錄標準",
    "advantage.moat4.title": "加工廠 / 營造廠網絡",
    "advantage.moat4.desc": "自主研發鋼筋施工圖自動化引擎，直接串接加工廠與營造廠的既有產業鏈",
    "faq.label": "FAQ 常見問題",
    "faq.heading": "常見問題",
    "faq.updated": "最後更新：2026-09-13",
    "faq.q1.q": "SetTime 是什麼？",
    "faq.q1.a": "SetTime 是 Kairos.ai 的營造／鋼筋產品。目前已上線的是鋼筋估算自動化：把結構施工圖轉成加工圖與計料資料，供估算與加工流程使用。AR 現場指導與 AI 竣工驗證是同一產品路線圖上的後續模組，開發中。",
    "faq.q2.q": "SetTime 現在可以使用哪些功能？",
    "faq.q2.a": "鋼筋估算自動化系統已上線：AutoCAD 2021 外掛與跨平台桌面版，將結構施工圖直接轉換為加工圖與計料表 (.xlsm)，可直接匯入加工廠既有巨集工具，樑柱辨識準確率達合約驗收門檻。AR 現場指導、AI 竣工驗證與法遵稽核鏈正在開發中。",
    ...
    "faq.q6.q": "稽核鏈能保證符合法規要求嗎？",
    "faq.q6.a": "不能，此功能目前開發中。稽核鏈是技術性防竄改機制（SHA-256 雜湊鏈），可偵測竄改與刪除，但不構成對任何特定法規、驗收基準或政府標案要求之合規保證。實際法遵義務依個案適用法規及契約條款而定，建議就個案洽詢法律顧問；本頁面內容不構成法律意見。",
    ...
    "contact.heading": ["讓我們一起", "打造可驗證的工地"],
  ...
  "en": {
    ...
    "hero.badge": "AI Rebar Estimation Automation Platform",
    "hero.title": ["Turn Structural Drawings Into", "Rebar Material Lists & Shop Drawings"],
    "hero.subtitle": "Shipping today: estimation automation. In development: AR field guidance and AI as-built checks.",
    "hero.subtitle-en": "From structural drawing to shop-ready rebar.",
    ...
    "hero.stat3.label": "Taiwan construction TAM (TWD, industry estimate)",
    "hero.stat3.unit": "T",
    ...
    "problem.stats.source": "Industry estimates, not measured results from this product.",
    "solution.label": "OUR TECHNOLOGY",
    "solution.heading": ["End-to-End Execution Pipeline"],
    "solution.lead": "The structural drawing is ground truth: estimation automation is shipping today. AR field guidance and AI verification are in development.",
    ...
    "solution.t1.en": "",
    "solution.t1.desc": "Structural drawing → bar schedule, cut list, bending list. Generates fabrication-ready data that drives shop machinery directly.",
    "solution.t1.m1": "Bar mark: B1 / B2 / B3",
    ...
    "product.tagline": "SetTime — Right before it sets",
    ...
    "product.m1": "Beam/column recognition meets acceptance threshold",
    ...
    "compliance.label": "LAW & COMPLIANCE",
    "compliance.heading": ["Every Record, Fully Retained for Audit and Legal Review"],
    "compliance.lead": "From drawing parsing to field verification, every action will be written to a tamper-evident audit chain (in development) — built to support the audit-review needs of large contractor groups and government tenders.",
    "compliance.moat1.title": "Tamper-Evident Hash Chain",
    "compliance.moat1.desc": "Every entry will be SHA-256 chained to the one before it — any edit or deletion instantly detectable (in development)",
    "compliance.moat2.title": "Precise Timestamping",
    "compliance.moat2.desc": "UTC timestamps with monotonic sequence numbers will rule out backdating, gaps, or reordering (in development)",
    "compliance.moat3.title": "Append-Only Audit Trail",
    "compliance.moat3.desc": "Entries can only be added, never edited or deleted — fully exportable for legal discovery and regulatory review (in development)",
    "compliance.moat4.title": "Long-Term Retention Architecture",
    "compliance.moat4.desc": "Schema-versioned records will stay fully verifiable across multi-year retention windows (in development)",
    "compliance.disclaimer": "The audit chain is a technical tamper-evidence mechanism, not a certification of compliance with any specific law, regulation, or government tender requirement. Actual compliance obligations depend on applicable law and contract terms; consult your own legal counsel. Nothing on this page constitutes legal advice.",
    ...
    "process.s2.en": "",
    "process.s2.desc": "Drives shop machinery; QR-tagging and pour-zone delivery are planned",
    ...
    "advantage.moat1.desc": "Every site adds as-built data, sharpening the model (in development) — a Taiwan-specific data moat",
    "advantage.moat2.title": "Local CV Models",
    "advantage.moat2.desc": "Verification models trained on Taiwanese sites and local rebar specs / practices (in development)",
    "advantage.moat3.title": "Public-Works Relationships",
    "advantage.moat3.desc": "Supports public-works audit-review needs (in development); helping shape smart-site as-built standards",
    "advantage.moat4.title": "Fabricator + Contractor Network",
    "advantage.moat4.desc": "In-house rebar shop-drawing automation engine, plugging directly into the existing fabricator and contractor chain",
    "faq.label": "FAQ",
    "faq.heading": "Frequently Asked Questions",
    "faq.updated": "Last updated: 2026-09-13",
    "faq.q1.q": "What is SetTime?",
    "faq.q1.a": "SetTime is Kairos.ai's construction/rebar product. What's shipping today is rebar estimation automation: it turns structural drawings into shop drawings and material-list data for estimation and fabrication. AR field guidance and AI as-built verification are later modules on the same product roadmap, in development.",
    "faq.q2.q": "What can SetTime do today?",
    "faq.q2.a": "The Rebar Estimation Automation System is shipping now: an AutoCAD 2021 plugin plus a cross-platform desktop app that converts structural drawings directly into shop drawings and a material-list workbook (.xlsm), importing natively into a fabricator's existing macro tooling, with beam/column recognition meeting acceptance thresholds. AR field guidance, AI as-built verification, and the law/compliance audit trail are in development.",
    ...
    "faq.q6.q": "Does the audit trail guarantee legal compliance?",
    "faq.q6.a": "No — and this feature is still in development. The audit trail is a technical tamper-evidence mechanism (SHA-256 hash chain) that detects alteration or deletion; it is not a certification of compliance with any specific law, regulation, or government tender requirement. Actual compliance obligations depend on applicable law and contract terms — consult your own legal counsel. Nothing on this page constitutes legal advice.",
    ...
    "contact.label": "GET IN TOUCH",
    "contact.heading": ["Let's Build", "Verifiable Job Sites Together"],
  ...
  "ja": {
    ...
    "status.live": "提供中",
    "status.dev": "開発中",
    "hero.badge": "AI 鉄筋積算自動化プラットフォーム",
    "hero.title": ["構造施工図を", "鉄筋計量表・加工図へ自動変換"],
    "hero.subtitle": "提供中：積算自動化（AutoCADプラグイン＋デスクトップ版）。開発中：AR結束指導、AI竣工照合と監査可能な記録。",
    "hero.subtitle-en": "From structural drawing to shop-ready rebar.",
    "hero.cta": "お問い合わせ",
    "hero.stat1.label": "鉄筋手戻り削減（目標）",
    "hero.stat2.label": "積算工数削減（目標）",
    "hero.stat3.label": "年間市場規模（TWD、業界推計）",
    "hero.stat3.unit": "兆",
    ...
    "problem.stats.source": "業界推計データであり、本製品の実測値ではありません。",
    "solution.label": "コア技術",
    "solution.heading": ["エンド・ツー・エンド施工実行パイプライン"],
    "solution.lead": "構造施工図を唯一の正とし、積算自動化は提供中。AR現場指導とAI竣工検証は開発中。",
    "aria.langSelect": "言語",
    ...
    "solution.t1.en": "Automated Drawing Parsing",
    "solution.t1.desc": "構造施工図 → 鉄筋計量表・切断表・加工表。加工工場に直接送出できるデジタルデータを自動生成。",
    "solution.t1.m1": "Bar Mark: B1 / B2 / B3",
    ...
    "product.tagline": "SetTime — 固まる前に、一発で決める",
    ...
    "compliance.label": "法令遵守・監査",
    "compliance.heading": ["すべての記録を監査・法的手続きのために完全保存"],
    "compliance.lead": "図面解析から現場検証まで、すべての操作は改ざんを検知可能な監査チェーンに記録される予定です（開発中）。大手建設グループや公共工事の監査対応ニーズを支援します。",
    "compliance.moat1.title": "改ざん検知可能なハッシュチェーン",
    "compliance.moat1.desc": "各記録は SHA-256 で前の記録とチェーン連結される予定で、改ざんや削除は即座に検知可能になります（開発中）",
    "compliance.moat2.title": "正確なタイムスタンプ",
    "compliance.moat2.desc": "UTC タイムスタンプと連続シーケンス番号により、遡及記入・欠番・時系列改ざんを防止する予定（開発中）",
    "compliance.moat3.title": "追記専用の監査記録",
    "compliance.moat3.desc": "記録は追加のみ可能で編集・削除不可の設計とし、法的証拠や監督機関の査察向けに完全出力できる予定（開発中）",
    "compliance.moat4.title": "長期保存対応アーキテクチャ",
    "compliance.moat4.desc": "記録形式はバージョン管理され、複数年にわたる保存期間でも完全に検証・復元できる設計を予定（開発中）",
    "compliance.disclaimer": "この監査チェーンは技術的な改ざん検知機構であり、特定の法令・規制・政府調達要件への準拠を保証するものではありません。実際のコンプライアンス義務は適用法令および契約条件によって異なります。個別の状況については弁護士にご相談ください。本ページの内容は法的助言を構成するものではありません。",
    ...
    "process.s2.en": "Fabricate & Deliver",
    "process.s2.desc": "加工工場の機械を駆動。QRタグ付けと打設区画別配送は計画中",
    ...
    "advantage.moat1.desc": "全現場の as-built データを蓄積しモデル精度を継続向上（開発中）、台湾特化のデータ堀",
    "advantage.moat2.title": "ローカルCVモデル",
    "advantage.moat2.desc": "台湾現場の実画像で訓練、国産鉄筋規格と工法に最適化（開発中）",
    "advantage.moat3.title": "公共工事との関係",
    "advantage.moat3.desc": "公共工事の監査対応ニーズを支援（開発中）、スマート現場の竣工記録標準策定にも参画",
    "advantage.moat4.title": "加工工場・ゼネコンネットワーク",
    "advantage.moat4.desc": "自社開発の鉄筋施工図自動化エンジンで、既存の加工工場・ゼネコンチェーンに直接接続",
    "faq.label": "FAQ よくある質問",
    "faq.heading": "よくある質問",
    "faq.updated": "最終更新日：2026-09-13",
    "faq.q1.q": "SetTimeとは何ですか？",
    "faq.q1.a": "SetTimeはKairos.aiの建設・鉄筋プロダクトです。現在提供中なのは鉄筋積算自動化：構造施工図を加工図と計量データに変換し、積算・加工工程で利用します。AR現場指導とAI竣工検証は同じロードマップ上の後続モジュールで、開発中です。",
    "faq.q2.q": "SetTimeは現在どんな機能が使えますか？",
    "faq.q2.a": "鉄筋積算自動化システムは提供中です。AutoCAD 2021プラグインとクロスプラットフォームのデスクトップ版で、構造施工図を施工図と計量表（.xlsm）に直接変換し、加工工場の既存マクロツールに取り込めます。梁・柱の認識精度は検収基準を満たします。AR現場指導、AI竣工検証、および法令遵守監査チェーンは開発中です。",
    ...
    "faq.q6.q": "監査チェーンは法令遵守を保証しますか？",
    "faq.q6.a": "いいえ。この機能は現在開発中です。監査チェーンは改ざんや削除を検知する技術的な仕組み（SHA-256ハッシュチェーン）であり、特定の法令・規制・政府調達要件への準拠を保証するものではありません。実際のコンプライアンス義務は適用法令および契約条件によって異なります。個別の状況については弁護士にご相談ください。本ページの内容は法的助言を構成するものではありません。",
    "pilot.label": "無料パイロット",
    ...
    "contact.heading": ["検証可能な現場を", "一緒につくりましょう"],
  ...
  "es": {
    ...
    "hero.badge": "Plataforma de Automatización de Estimación de Armadura con IA",
    "hero.title": ["Planos Estructurales, Convertidos", "en Listas de Armadura y Planos de Taller"],
    "hero.subtitle": "Disponible: automatización de estimación (plugin AutoCAD + escritorio). En desarrollo: guía de RA en obra, verificación con IA y registros auditables.",
    "hero.subtitle-en": "From structural drawing to shop-ready rebar.",
    ...
    "hero.stat3.label": "Mercado de construcción en Taiwán (TWD, estimación del sector)",
    "hero.stat3.unit": "T",
    ...
    "problem.stats.source": "Estimaciones del sector, no resultados medidos por este producto.",
    "solution.label": "NUESTRA TECNOLOGÍA",
    "solution.heading": ["Pipeline de Ejecución de Extremo a Extremo"],
    "solution.lead": "El plano estructural es la fuente de verdad: la automatización de estimación ya está disponible. La guía de RA y la verificación con IA están en desarrollo.",
    ...
    "solution.t1.en": "",
    "solution.t1.desc": "Plano estructural → lista de despiece, lista de corte, lista de doblado. Genera datos listos para producción que alimentan directamente la maquinaria del taller.",
    "solution.t1.m1": "Bar Mark: B1 / B2 / B3",
    ...
    "product.tagline": "SetTime — Justo antes de que fragüe",
    ...
    "product.m1": "Reconocimiento de vigas/columnas cumple el umbral de aceptación",
    ...
    "compliance.label": "LEGAL Y CUMPLIMIENTO",
    "compliance.heading": ["Cada Registro, Conservado Íntegramente para Auditorías y Procesos Legales"],
    "compliance.lead": "Desde el análisis de planos hasta la verificación en obra, cada acción se escribirá en una cadena de auditoría con integridad verificable (en desarrollo), diseñada para respaldar las necesidades de revisión de auditoría de grandes constructoras y licitaciones públicas.",
    "compliance.moat1.title": "Cadena de Hash con Integridad Verificable",
    "compliance.moat1.desc": "Cada registro se encadenará mediante SHA-256 al anterior; cualquier edición o eliminación se detectará al instante (en desarrollo)",
    "compliance.moat2.title": "Marca de Tiempo Precisa",
    "compliance.moat2.desc": "Marcas de tiempo UTC con números de secuencia monótonos que impedirán retrodatación, huecos o reordenamiento (en desarrollo)",
    "compliance.moat3.title": "Registro de Auditoría de Solo Adición",
    "compliance.moat3.desc": "Los registros solo podrán añadirse, nunca editarse ni eliminarse; exportable para litigios y revisión regulatoria (en desarrollo)",
    "compliance.moat4.title": "Arquitectura de Retención a Largo Plazo",
    "compliance.moat4.desc": "Los registros con versión de esquema seguirán siendo verificables en periodos de retención de varios años (en desarrollo)",
    "compliance.disclaimer": "La cadena de auditoría es un mecanismo técnico de detección de manipulaciones, no una certificación de cumplimiento con ninguna ley, normativa o requisito de contratación pública específicos. Las obligaciones reales de cumplimiento dependen de la legislación aplicable y de los términos contractuales; consulte con su propio asesor legal. Nada en esta página constituye asesoramiento legal.",
    ...
    "process.s2.en": "",
    "process.s2.desc": "Controla la maquinaria del taller; el etiquetado QR y la entrega por zona de vertido están planificados",
    ...
    "advantage.r1.edge": "Análisis automático + alineación RA (en desarrollo)",
    ...
    "advantage.r2.edge": "RA llevada a la losa (en desarrollo)",
    ...
    "advantage.r3.edge": "Verificación continua con IA (en desarrollo)",
    ...
    "advantage.moat1.desc": "Cada obra suma datos as-built que afinan el modelo (en desarrollo) — un foso de datos específico de Taiwán",
    "advantage.moat2.title": "Modelos de Visión Locales",
    "advantage.moat2.desc": "Modelos de verificación entrenados en obras taiwanesas con especificaciones y prácticas locales de armadura (en desarrollo)",
    "advantage.moat3.title": "Relaciones con Obra Pública",
    "advantage.moat3.desc": "Respalda las necesidades de revisión de auditoría de obra pública (en desarrollo); ayuda a definir estándares de registro as-built para obras inteligentes",
    "advantage.moat4.title": "Red de Fabricantes y Contratistas",
    "advantage.moat4.desc": "Motor propio de automatización de planos de taller de armadura, conectado directamente con la cadena existente de fabricantes y contratistas",
    "faq.label": "FAQ Preguntas frecuentes",
    "faq.heading": "Preguntas frecuentes",
    "faq.updated": "Última actualización: 2026-09-13",
    "faq.q1.q": "¿Qué es SetTime?",
    "faq.q1.a": "SetTime es el producto de construcción/armadura de Kairos.ai. Lo que ya está disponible es la automatización de estimación de armadura: convierte planos estructurales en planos de taller y datos de listas de materiales para estimación y fabricación. La guía de RA en campo y la verificación as-built con IA son módulos posteriores en la misma hoja de ruta, en desarrollo.",
    "faq.q2.q": "¿Qué puede hacer SetTime hoy?",
    "faq.q2.a": "El Sistema de Automatización de Estimación de Armadura ya está disponible: un plugin para AutoCAD 2021 y una app de escritorio multiplataforma que convierte planos estructurales directamente en planos de taller y una lista de materiales (.xlsm), compatible con las herramientas de macros del fabricante, con reconocimiento de vigas/columnas que cumple el umbral de aceptación. La guía de RA en campo, la verificación as-built con IA y la cadena de auditoría de cumplimiento legal están en desarrollo.",
    ...
    "faq.q6.q": "¿La cadena de auditoría garantiza el cumplimiento legal?",
    "faq.q6.a": "No, y esta función todavía está en desarrollo. La cadena de auditoría es un mecanismo técnico de detección de manipulaciones (cadena de hash SHA-256) que detecta alteraciones o eliminaciones; no es una certificación de cumplimiento con ninguna ley, normativa o requisito de contratación pública específicos. Las obligaciones reales de cumplimiento dependen de la legislación aplicable y de los términos contractuales; consulte con su propio asesor legal. Nada en esta página constituye asesoramiento legal.",
    ...
    "contact.heading": ["Construyamos Juntos", "Obras Verificables"],
  ...
  "fr": {
    ...
    "hero.badge": "Plateforme d'Automatisation de l'Estimation d'Armature par IA",
    "hero.title": ["Plans Structurels, Convertis", "en Nomenclatures d'Armature et Plans d'Atelier"],
    "hero.subtitle": "Disponible : automatisation de l'estimation (plugin AutoCAD + bureau). En développement : guidage RA sur chantier, vérification par IA et dossier auditable.",
    "hero.subtitle-en": "From structural drawing to shop-ready rebar.",
    ...
    "hero.stat3.label": "Marché de la construction à Taïwan (TWD, estimation du secteur)",
    "hero.stat3.unit": "T",
    ...
    "problem.stats.source": "Estimations du secteur, pas des résultats mesurés par ce produit.",
    "solution.label": "NOTRE TECHNOLOGIE",
    "solution.heading": ["Un Pipeline d'Exécution de Bout en Bout"],
    "solution.lead": "Le plan de structure fait foi : l'automatisation de l'estimation est disponible dès maintenant. Le guidage RA et la vérification par IA sont en développement.",
    ...
    "solution.t1.en": "",
    "solution.t1.desc": "Plan de structure → nomenclature d'armatures, liste de découpe, liste de façonnage. Génère des données prêtes pour la production qui pilotent directement les machines d'atelier.",
    "solution.t1.m1": "Bar Mark : B1 / B2 / B3",
    ...
    "product.tagline": "SetTime — Juste avant la prise",
    ...
    "product.m1": "Reconnaissance poutres/poteaux conforme au seuil de réception",
    ...
    "compliance.label": "DROIT & CONFORMITÉ",
    "compliance.heading": ["Chaque Enregistrement, Conservé Intégralement pour l'Audit et les Procédures Juridiques"],
    "compliance.lead": "De l'analyse des plans à la vérification sur site, chaque action sera inscrite dans une chaîne d'audit à intégrité vérifiable (en développement), conçue pour appuyer les besoins de revue d'audit des grands groupes de construction et des marchés publics.",
    "compliance.moat1.title": "Chaîne de Hachage à Intégrité Vérifiable",
    "compliance.moat1.desc": "Chaque entrée sera chaînée par SHA-256 à la précédente ; toute modification ou suppression sera immédiatement détectable (en développement)",
    "compliance.moat2.title": "Horodatage Précis",
    "compliance.moat2.desc": "Horodatage UTC avec numéros de séquence monotones excluant l'antidatage, les trous ou la réorganisation (en développement)",
    "compliance.moat3.title": "Journal d'Audit en Ajout Seul",
    "compliance.moat3.desc": "Les entrées ne pourront être qu'ajoutées, jamais modifiées ni supprimées — exportable pour litiges et contrôles réglementaires (en développement)",
    "compliance.moat4.title": "Architecture de Conservation à Long Terme",
    "compliance.moat4.desc": "Les enregistrements versionnés resteront entièrement vérifiables sur des périodes de conservation pluriannuelles (en développement)",
    "compliance.disclaimer": "La chaîne d'audit est un mécanisme technique de détection des altérations, et non une certification de conformité à une loi, une réglementation ou une exigence de marché public spécifique. Les obligations réelles de conformité dépendent du droit applicable et des clauses contractuelles ; consultez votre propre conseil juridique. Rien sur cette page ne constitue un avis juridique.",
    ...
    "process.s2.en": "",
    "process.s2.desc": "Pilote les machines d'atelier ; l'étiquetage QR et la livraison par zone de coulage sont prévus",
    ...
    "advantage.r1.edge": "Analyse automatique + alignement RA (en développement)",
    ...
    "advantage.r2.edge": "La RA apportée jusqu'à la dalle (en développement)",
    ...
    "advantage.r3.edge": "Vérification continue par IA (en développement)",
    ...
    "advantage.moat1.desc": "Chaque chantier enrichit les données tel-que-construit et affine le modèle (en développement) — une barrière de données propre à Taïwan",
    "advantage.moat2.title": "Modèles de Vision Locaux",
    "advantage.moat2.desc": "Modèles de vérification entraînés sur des chantiers taïwanais, aux normes et pratiques d'armature locales (en développement)",
    "advantage.moat3.title": "Relations avec les Marchés Publics",
    "advantage.moat3.desc": "Appuie les besoins de revue d'audit des marchés publics (en développement) ; contribue à définir les normes de dossier des ouvrages exécutés pour les chantiers intelligents",
    "advantage.moat4.title": "Réseau Façonneurs + Entreprises",
    "advantage.moat4.desc": "Moteur propriétaire d'automatisation des plans d'atelier d'armature, connecté directement à la chaîne existante de façonneurs et d'entreprises",
    "faq.label": "FAQ Questions fréquentes",
    "faq.heading": "Questions fréquentes",
    "faq.updated": "Dernière mise à jour : 2026-09-13",
    "faq.q1.q": "Qu'est-ce que SetTime ?",
    "faq.q1.a": "SetTime est le produit construction/armature de Kairos.ai. Ce qui est disponible aujourd'hui, c'est l'automatisation de l'estimation d'armature : elle convertit les plans structurels en plans d'atelier et données de nomenclature pour l'estimation et le façonnage. Le guidage RA sur site et la vérification as-built par IA sont des modules ultérieurs de la même feuille de route, en développement.",
    "faq.q2.q": "Que peut faire SetTime aujourd'hui ?",
    "faq.q2.a": "Le système d'automatisation d'estimation d'armature est disponible dès maintenant : un plugin AutoCAD 2021 et une application de bureau multiplateforme qui convertit les plans structurels directement en plans d'atelier et une nomenclature (.xlsm), compatible avec les outils macro existants du façonneur, avec une reconnaissance poutres/poteaux conforme au seuil de réception. Le guidage RA sur chantier, la vérification as-built par IA et la chaîne d'audit de conformité légale sont en développement.",
    ...
    "faq.q6.q": "La chaîne d'audit garantit-elle la conformité légale ?",
    "faq.q6.a": "Non, et cette fonctionnalité est encore en développement. La chaîne d'audit est un mécanisme technique de détection des altérations (chaîne de hachage SHA-256) qui détecte les modifications ou suppressions ; elle ne certifie pas la conformité à une loi, une réglementation ou une exigence de marché public spécifique. Les obligations réelles de conformité dépendent du droit applicable et des clauses contractuelles ; consultez votre propre conseil juridique. Rien sur cette page ne constitue un avis juridique.",
    ...
    "contact.heading": ["Construisons Ensemble", "des Chantiers Vérifiables"],
  ...
  "de": {
    ...
    "hero.badge": "KI-Plattform zur Automatisierung der Bewehrungskalkulation",
    "hero.title": ["Statikpläne, Automatisch", "in Bewehrungslisten & Werkstattzeichnungen"],
    "hero.subtitle": "Verfügbar: Kalkulationsautomatisierung (AutoCAD-Plugin + Desktop). In Entwicklung: AR-Baustellenführung, KI-Abnahmeprüfung und prüfbare Dokumentation.",
    "hero.subtitle-en": "From structural drawing to shop-ready rebar.",
    ...
    "hero.stat3.label": "Bauvolumen Taiwan p. a. (TWD, Branchenschätzung)",
    "hero.stat3.unit": "Bio.",
    ...
    "problem.stats.source": "Branchenschätzungen, keine Messwerte dieses Produkts.",
    "solution.label": "UNSERE TECHNOLOGIE",
    "solution.heading": ["Durchgängige Ausführungs-Pipeline"],
    "solution.lead": "Der Statikplan ist die einzige Wahrheit: Die Kalkulationsautomatisierung ist bereits verfügbar. AR-Führung und KI-Prüfung sind in Entwicklung.",
    ...
    "solution.t1.en": "",
    "solution.t1.desc": "Statikplan → Biegeliste, Schnittliste, Stahlliste. Erzeugt produktionsreife Daten, die die Werkstattmaschinen direkt ansteuern.",
    "solution.t1.m1": "Bar Mark: B1 / B2 / B3",
    ...
    "product.tagline": "SetTime — Rechtzeitig, bevor es abbindet",
    ...
    "product.m1": "Träger-/Stützenerkennung erfüllt Abnahmeschwelle",
    ...
    "compliance.label": "RECHT & COMPLIANCE",
    "compliance.heading": ["Jeder Eintrag, Vollständig Aufbewahrt für Audit und Rechtsverfahren"],
    "compliance.lead": "Von der Plananalyse bis zur Baustellenverifizierung wird jede Aktion künftig in eine manipulationserkennbare Audit-Kette geschrieben (in Entwicklung) — konzipiert, um die Audit-Review-Anforderungen großer Baukonzerne und öffentlicher Ausschreibungen zu unterstützen.",
    "compliance.moat1.title": "Manipulationserkennbare Hash-Kette",
    "compliance.moat1.desc": "Jeder Eintrag wird per SHA-256 mit dem vorherigen verkettet — jede Änderung oder Löschung wird sofort erkennbar sein (in Entwicklung)",
    "compliance.moat2.title": "Präzise Zeitstempel",
    "compliance.moat2.desc": "UTC-Zeitstempel mit fortlaufenden Sequenznummern werden Rückdatierung, Lücken oder Umordnung ausschließen (in Entwicklung)",
    "compliance.moat3.title": "Nur-Anhängen-Audit-Protokoll",
    "compliance.moat3.desc": "Einträge können nur hinzugefügt, nie bearbeitet oder gelöscht werden — vollständig exportierbar für Rechtsverfahren und behördliche Prüfungen (in Entwicklung)",
    "compliance.moat4.title": "Architektur für Langzeitarchivierung",
    "compliance.moat4.desc": "Versionierte Datensätze sollen über mehrjährige Aufbewahrungsfristen hinweg vollständig verifizierbar bleiben (in Entwicklung)",
    "compliance.disclaimer": "Die Audit-Kette ist ein technischer Mechanismus zur Erkennung von Manipulationen, keine Zertifizierung der Einhaltung eines bestimmten Gesetzes, einer Vorschrift oder einer Vergabeanforderung. Die tatsächlichen Compliance-Pflichten richten sich nach geltendem Recht und den Vertragsbedingungen; wenden Sie sich an Ihren eigenen Rechtsberater. Nichts auf dieser Seite stellt eine Rechtsberatung dar.",
    ...
    "process.s2.en": "",
    "process.s2.desc": "Steuert die Werkstattmaschinen an; QR-Kennzeichnung und Lieferung nach Betonierabschnitt sind geplant",
    ...
    "advantage.r1.edge": "Automatische Auswertung + AR-Abgleich (in Entwicklung)",
    ...
    "advantage.r2.edge": "AR direkt auf die Bodenplatte gebracht (in Entwicklung)",
    ...
    "advantage.r3.edge": "Durchgängige KI-Prüfung (in Entwicklung)",
    ...
    "advantage.moat1.desc": "Jede Baustelle liefert Bestandsdaten, die das Modell schärfen (in Entwicklung) — ein Taiwan-spezifischer Datengraben",
    "advantage.moat2.title": "Lokale CV-Modelle",
    "advantage.moat2.desc": "Prüfmodelle, trainiert an taiwanesischen Baustellen mit lokalen Bewehrungsnormen und -praktiken (in Entwicklung)",
    "advantage.moat3.title": "Beziehungen zu öffentlichen Auftraggebern",
    "advantage.moat3.desc": "Unterstützt die Audit-Review-Anforderungen öffentlicher Auftraggeber (in Entwicklung); wirkt an Standards für Bestandsdokumentation auf Smart-Baustellen mit",
    "advantage.moat4.title": "Netzwerk aus Fertigungsbetrieben und Bauunternehmen",
    "advantage.moat4.desc": "Eigene Automatisierungs-Engine für Bewehrungs-Werkstattzeichnungen, direkt angebunden an die bestehende Kette aus Fertigungsbetrieben und Bauunternehmen",
    "faq.label": "FAQ Häufige Fragen",
    "faq.heading": "Häufige Fragen",
    "faq.updated": "Zuletzt aktualisiert: 2026-09-13",
    "faq.q1.q": "Was ist SetTime?",
    "faq.q1.a": "SetTime ist das Bau-/Bewehrungsprodukt von Kairos.ai. Bereits verfügbar ist die Bewehrungskalkulationsautomatisierung: Sie wandelt Statikpläne in Werkstattzeichnungen und Materiallistendaten für Kalkulation und Fertigung um. AR-Feldführung und KI-Bestandsprüfung sind spätere Module auf derselben Produkt-Roadmap, in Entwicklung.",
    "faq.q2.q": "Was kann SetTime heute schon?",
    "faq.q2.a": "Das System zur Automatisierung der Bewehrungskalkulation ist bereits verfügbar: ein AutoCAD-2021-Plugin plus eine plattformübergreifende Desktop-App, die Statikpläne direkt in Werkstattzeichnungen und eine Materialliste (.xlsm) umwandelt und nativ in bestehende Makro-Tools des Verarbeiters importiert, mit einer Balken-/Stützenerkennung, die die Abnahmeschwelle erfüllt. AR-Feldführung, KI-basierte Bestandsprüfung und die Recht-/Compliance-Audit-Kette sind in Entwicklung.",
    ...
    "faq.q6.q": "Garantiert die Audit-Kette die Einhaltung gesetzlicher Vorschriften?",
    "faq.q6.a": "Nein, und diese Funktion befindet sich noch in der Entwicklung. Die Audit-Kette ist ein technischer Mechanismus zur Erkennung von Manipulationen (SHA-256-Hash-Kette), der Änderungen oder Löschungen erkennt; sie ist keine Zertifizierung der Einhaltung eines bestimmten Gesetzes, einer Vorschrift oder einer Vergabeanforderung. Die tatsächlichen Compliance-Pflichten richten sich nach geltendem Recht und den Vertragsbedingungen; wenden Sie sich an Ihren eigenen Rechtsberater. Nichts auf dieser Seite stellt eine Rechtsberatung dar.",
    ...
    "contact.heading": ["Lassen Sie Uns Gemeinsam", "Verifizierbare Baustellen Schaffen"],
  ...
  "it": {
    ...
    "hero.badge": "Piattaforma di Automazione del Computo Armature con IA",
    "hero.title": ["Disegni Strutturali, Trasformati", "in Distinte Armature e Disegni Officina"],
    "hero.subtitle": "Disponibile: automazione del computo (plugin AutoCAD + desktop). In sviluppo: guida AR in cantiere, verifica con IA e registro verificabile.",
    "hero.subtitle-en": "From structural drawing to shop-ready rebar.",
    ...
    "hero.stat3.label": "Mercato delle costruzioni a Taiwan (TWD, stima di settore)",
    "hero.stat3.unit": "T",
    ...
    "problem.stats.source": "Stime di settore, non risultati misurati da questo prodotto.",
    "solution.label": "LA NOSTRA TECNOLOGIA",
    "solution.heading": ["Pipeline di Esecuzione End-to-End"],
    "solution.lead": "Il disegno strutturale è l'unica fonte di verità: l'automazione del computo è già disponibile. La guida AR e la verifica con IA sono in sviluppo.",
    ...
    "solution.t1.en": "",
    "solution.t1.desc": "Disegno strutturale → distinta ferri, lista di taglio, lista di piegatura. Genera dati pronti per la produzione che pilotano direttamente i macchinari d'officina.",
    "solution.t1.m1": "Bar Mark: B1 / B2 / B3",
    ...
    "product.tagline": "SetTime — Giusto prima che faccia presa",
    ...
    "product.m1": "Riconoscimento travi/pilastri conforme alla soglia di collaudo",
    ...
    "compliance.label": "LEGALE E CONFORMITÀ",
    "compliance.heading": ["Ogni Registrazione, Conservata Integralmente per Audit e Procedimenti Legali"],
    "compliance.lead": "Dall'analisi dei disegni alla verifica in cantiere, ogni azione verrà scritta in una catena di audit a manomissione rilevabile (in sviluppo), pensata per supportare le esigenze di revisione di audit di grandi gruppi edili e gare d'appalto pubbliche.",
    "compliance.moat1.title": "Catena di Hash a Manomissione Rilevabile",
    "compliance.moat1.desc": "Ogni voce sarà concatenata con SHA-256 a quella precedente; qualsiasi modifica o eliminazione sarà rilevata istantaneamente (in sviluppo)",
    "compliance.moat2.title": "Marcatura Temporale Precisa",
    "compliance.moat2.desc": "Timestamp UTC con numeri di sequenza monotoni che escluderanno retrodatazioni, lacune o riordinamenti (in sviluppo)",
    "compliance.moat3.title": "Registro di Audit Solo in Aggiunta",
    "compliance.moat3.desc": "Le voci potranno essere solo aggiunte, mai modificate o eliminate — esportabile per contenziosi legali e verifiche regolatorie (in sviluppo)",
    "compliance.moat4.title": "Architettura per Conservazione a Lungo Termine",
    "compliance.moat4.desc": "I record con versione dello schema resteranno completamente verificabili su periodi di conservazione pluriennali (in sviluppo)",
    "compliance.disclaimer": "La catena di audit è un meccanismo tecnico di rilevamento delle manomissioni, non una certificazione di conformità a una legge, normativa o requisito di appalto pubblico specifico. Gli effettivi obblighi di conformità dipendono dalla legge applicabile e dai termini contrattuali; consultare un proprio legale. Nulla in questa pagina costituisce consulenza legale.",
    ...
    "process.s2.en": "",
    "process.s2.desc": "Pilota le macchine di officina; l'etichettatura QR e la consegna per zona di getto sono previste",
    ...
    "advantage.r1.edge": "Analisi automatica + allineamento AR (in sviluppo)",
    ...
    "advantage.r2.edge": "AR portata sul getto (in sviluppo)",
    ...
    "advantage.r3.edge": "Verifica continua con IA (in sviluppo)",
    ...
    "advantage.moat1.desc": "Ogni cantiere aggiunge dati as-built che affinano il modello (in sviluppo) — un vantaggio di dati specifico per Taiwan",
    "advantage.moat2.title": "Modelli di Visione Locali",
    "advantage.moat2.desc": "Modelli di verifica addestrati su cantieri taiwanesi, sulle specifiche e prassi locali di armatura (in sviluppo)",
    "advantage.moat3.title": "Rapporti con le Opere Pubbliche",
    "advantage.moat3.desc": "Supporta le esigenze di revisione di audit delle opere pubbliche (in sviluppo); contribuisce a definire gli standard di registro as-built per i cantieri intelligenti",
    "advantage.moat4.title": "Rete di Officine e Imprese",
    "advantage.moat4.desc": "Motore proprietario di automazione dei disegni di officina per armature, collegato direttamente alla filiera esistente di officine e imprese",
    "faq.label": "FAQ Domande frequenti",
    "faq.heading": "Domande frequenti",
    "faq.updated": "Ultimo aggiornamento: 2026-09-13",
    "faq.q1.q": "Cos'è SetTime?",
    "faq.q1.a": "SetTime è il prodotto costruzioni/armature di Kairos.ai. Ciò che è già disponibile è l'automazione del computo armature: converte i disegni strutturali in disegni di officina e dati per le distinte materiali, per il computo e la lavorazione. La guida AR in campo e la verifica as-built con IA sono moduli successivi sulla stessa roadmap, in sviluppo.",
    "faq.q2.q": "Cosa può fare SetTime oggi?",
    "faq.q2.a": "Il Sistema di Automazione del Computo Armature è già disponibile: un plugin per AutoCAD 2021 più un'app desktop multipiattaforma che converte i disegni strutturali direttamente in disegni di officina e in una distinta materiali (.xlsm), importabile negli strumenti macro esistenti del fabbricante, con un riconoscimento travi/pilastri conforme alla soglia di collaudo. La guida AR in campo, la verifica as-built con IA e la catena di audit legale/di conformità sono in sviluppo.",
    ...
    "faq.q6.q": "La catena di audit garantisce la conformità legale?",
    "faq.q6.a": "No, e questa funzione è ancora in sviluppo. La catena di audit è un meccanismo tecnico di rilevamento delle manomissioni (catena di hash SHA-256) che rileva alterazioni o cancellazioni; non è una certificazione di conformità a una legge, normativa o requisito di appalto pubblico specifico. Gli effettivi obblighi di conformità dipendono dalla legge applicabile e dai termini contrattuali; consultare un proprio legale. Nulla in questa pagina costituisce consulenza legale.",
    ...
    "contact.heading": ["Costruiamo Insieme", "Cantieri Verificabili"],
  ...
  "pt": {
    ...
    "hero.badge": "Plataforma de Automação de Orçamento de Armação com IA",
    "hero.title": ["Desenhos Estruturais, Convertidos", "em Listas de Armação e Desenhos de Oficina"],
    "hero.subtitle": "Disponível: automação de orçamento (plugin AutoCAD + desktop). Em desenvolvimento: orientação em RA no canteiro, verificação com IA e registro auditável.",
    "hero.subtitle-en": "From structural drawing to shop-ready rebar.",
    ...
    "hero.stat3.label": "Mercado da construção em Taiwan (TWD, estimativa do setor)",
    "hero.stat3.unit": "T",
    ...
    "problem.stats.source": "Estimativas do setor, não resultados medidos por este produto.",
    "solution.label": "NOSSA TECNOLOGIA",
    "solution.heading": ["Pipeline de Execução de Ponta a Ponta"],
    "solution.lead": "O desenho estrutural é a fonte da verdade: a automação de orçamento já está disponível. A orientação em RA e a verificação com IA estão em desenvolvimento.",
    "aria.langSelect": "Idioma",
    ...
    "solution.t1.en": "",
    "solution.t1.desc": "Desenho estrutural → lista de ferros, lista de corte, lista de dobra. Gera dados prontos para produção que alimentam diretamente as máquinas da oficina.",
    "solution.t1.m1": "Bar Mark: B1 / B2 / B3",
    ...
    "product.tagline": "SetTime — Na hora certa, antes de curar",
    ...
    "product.m1": "Reconhecimento de vigas/pilares atende ao limiar de aceitação",
    ...
    "compliance.label": "DIREITO E CONFORMIDADE",
    "compliance.heading": ["Cada Registro, Preservado Integralmente para Auditorias e Processos Legais"],
    "compliance.lead": "Da análise de desenhos à verificação em obra, cada ação será gravada numa cadeia de auditoria com integridade verificável (em desenvolvimento), criada para apoiar as necessidades de revisão de auditoria de grandes construtoras e licitações públicas.",
    "compliance.moat1.title": "Cadeia de Hash com Integridade Verificável",
    "compliance.moat1.desc": "Cada registro será encadeado via SHA-256 ao anterior; qualquer edição ou exclusão será detectada instantaneamente (em desenvolvimento)",
    "compliance.moat2.title": "Carimbo de Tempo Preciso",
    "compliance.moat2.desc": "Carimbos de tempo UTC com números de sequência monótonos que impedirão retrodatação, lacunas ou reordenação (em desenvolvimento)",
    "compliance.moat3.title": "Trilha de Auditoria Somente-Adição",
    "compliance.moat3.desc": "Os registros só poderão ser adicionados, nunca editados ou excluídos — totalmente exportável para litígios e revisão regulatória (em desenvolvimento)",
    "compliance.moat4.title": "Arquitetura de Retenção de Longo Prazo",
    "compliance.moat4.desc": "Registros com versão de esquema permanecerão totalmente verificáveis em janelas de retenção plurianuais (em desenvolvimento)",
    "compliance.disclaimer": "A cadeia de auditoria é um mecanismo técnico de detecção de adulteração, não uma certificação de conformidade com qualquer lei, regulamento ou requisito de licitação pública específico. As obrigações reais de conformidade dependem da legislação aplicável e dos termos contratuais; consulte seu próprio advogado. Nada nesta página constitui aconselhamento jurídico.",
    ...
    "process.s2.en": "",
    "process.s2.desc": "Aciona as máquinas da oficina; a etiquetagem QR e a entrega por zona de concretagem estão planejadas",
    ...
    "advantage.r1.edge": "Análise automática + alinhamento por RA (em desenvolvimento)",
    ...
    "advantage.r2.edge": "RA levada até a laje (em desenvolvimento)",
    ...
    "advantage.r3.edge": "Verificação contínua com IA (em desenvolvimento)",
    ...
    "advantage.moat1.desc": "Cada obra soma dados as-built que refinam o modelo (em desenvolvimento) — um fosso de dados específico de Taiwan",
    "advantage.moat2.title": "Modelos de Visão Locais",
    "advantage.moat2.desc": "Modelos de verificação treinados em obras taiwanesas, com especificações e práticas locais de armação (em desenvolvimento)",
    "advantage.moat3.title": "Relações com Obras Públicas",
    "advantage.moat3.desc": "Apoia as necessidades de revisão de auditoria de obras públicas (em desenvolvimento); ajuda a definir padrões de registro as-built para canteiros inteligentes",
    "advantage.moat4.title": "Rede de Fabricantes e Empreiteiras",
    "advantage.moat4.desc": "Motor próprio de automação de desenhos de oficina de armação, conectado diretamente à cadeia existente de fabricantes e empreiteiras",
    "faq.label": "FAQ Perguntas frequentes",
    "faq.heading": "Perguntas frequentes",
    "faq.updated": "Última atualização: 2026-09-13",
    "faq.q1.q": "O que é o SetTime?",
    "faq.q1.a": "O SetTime é o produto de construção/armação da Kairos.ai. O que já está disponível é a automação de orçamento de armação: converte desenhos estruturais em desenhos de oficina e dados de lista de materiais para orçamento e fabricação. A orientação em RA no canteiro e a verificação as-built com IA são módulos posteriores no mesmo roteiro de produto, em desenvolvimento.",
    "faq.q2.q": "O que o SetTime já faz hoje?",
    "faq.q2.a": "O Sistema de Automação de Orçamento de Armação já está disponível: um plugin para AutoCAD 2021 e um aplicativo desktop multiplataforma que converte projetos estruturais diretamente em desenhos de oficina e uma lista de materiais (.xlsm), importável nativamente nas ferramentas de macro já usadas pelo fabricante, com reconhecimento de vigas/pilares que atende ao limiar de aceitação. A orientação em RA no campo, a verificação as-built com IA e a cadeia de auditoria jurídica/de conformidade estão em desenvolvimento.",
    ...
    "faq.q6.q": "A cadeia de auditoria garante conformidade legal?",
    "faq.q6.a": "Não, e este recurso ainda está em desenvolvimento. A cadeia de auditoria é um mecanismo técnico de detecção de adulteração (cadeia de hash SHA-256) que detecta alterações ou exclusões; não é uma certificação de conformidade com qualquer lei, regulamento ou requisito de licitação pública específico. As obrigações reais de conformidade dependem da legislação aplicável e dos termos contratuais; consulte seu próprio advogado. Nada nesta página constitui aconselhamento jurídico.",
    "pilot.label": "PILOTO GRATUITO",
    ...
    "contact.heading": ["Vamos Construir Juntos", "Obras Verificáveis"],
